...
const ANIMALS = [
  ...
  { id: "tigre",       name: "Tigre",         emoji: "🐯", tier: "savane", ground: "jungle" },
  ...
  { id: "singe",       name: "Singe",         emoji: "🐵", tier: "savane", ground: "jungle" },
  { id: "gorille",     name: "Gorille",       emoji: "🦍", tier: "savane", ground: "jungle" },
  { id: "crocodile",   name: "Crocodile",     emoji: "🐊", tier: "savane", ground: "water" },
  { id: "serpent",     name: "Serpent",       emoji: "🐍", tier: "savane", ground: "jungle" },
  { id: "flamant",     name: "Flamant rose",  emoji: "🦩", tier: "savane", ground: "water" },
  { id: "paon",        name: "Paon",          emoji: "🦚", tier: "savane", ground: "jungle" },
  { id: "perroquet",   name: "Perroquet",     emoji: "🦜", tier: "savane", ground: "jungle" },
  { id: "kangourou",   name: "Kangourou",     emoji: "🦘", tier: "savane", ground: "sand" },

  // --- Les exotiques (rares) ---
  { id: "panda",       name: "Panda",         emoji: "🐼", tier: "exotique", ground: "jungle" },
  { id: "koala",       name: "Koala",         emoji: "🐨", tier: "exotique", ground: "jungle" },
  { id: "paresseux",   name: "Paresseux",     emoji: "🦥", tier: "exotique", ground: "jungle" },
